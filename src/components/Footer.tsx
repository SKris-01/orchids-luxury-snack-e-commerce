        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="space-y-6">
              <Link href="/" className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-2xl font-serif tracking-[0.2em] text-gold">Shriyans</h2>
                  <p className="text-[10px] tracking-[0.3em] text-gold/60 uppercase">Premium Lotus Seeds</p>
                </div>
              </Link>
              <p className="text-cream/60 text-sm leading-relaxed">
                Nurturing the golden grain of Mithila since 1985. 
                Bringing the royalty of hand-picked, slow-roasted lotus seeds to the global gourmet stage.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: "Classic Roasted", href: "/products?category=classic" },
                  { label: "Luxury Blends", href: "/products?category=luxury" },
                  { label: "Gift Hampers", href: "/products?category=gifts" },
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-cream/60 text-sm mb-4">
                  Subscribe for exclusive access to limited editions and royal tastings.
                </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-cream/60 text-sm">
                  ...
                  <span>Heritage Estate, Mithila, Bihar, India</span>
                </div>
                <div className="flex items-center gap-3 text-cream/60 text-sm">
                  <Phone className="h-4 w-4 text-gold" />
                  <span>+91 (800) SHRIYANS</span>
                </div>
                <div className="flex items-center gap-3 text-cream/60 text-sm">
                  <Mail className="h-4 w-4 text-gold" />
                  <span>concierge@shriyans.com</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-gold/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-cream/40 text-sm">
                © 2026 Shriyans Lotus Seeds. All rights reserved.
              </p>
